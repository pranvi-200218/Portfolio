...
document.addEventListener("keydown", e => {
  if (e.key === "Escape") modalViews.forEach(mv => mv.classList.remove("active-modal"));
});
...
(function injectSkillBars() {
  const skillMap = {
    "Java": 75, "HTML5": 85, "CSS3": 80, "JavaScript": 60,
    "MySQL": 65, "PHP": 55, "C": 70, "Network Security": 72,
    "Cryptography": 65, "Ethical Hacking": 68, "System Administration": 60,
    "Threat Analysis": 63, "Vulnerability Assessment": 60
  };
